(function(){
  ...
  var baseData={
    ...
    ranks:{
      doctor:[['曾凯','医生组','在管 13 人','住院规模（9.13—9.19 表）','动态试算'],['王建宁','医生组','在管 13 人 · 在院 8','住院规模（9.13—9.19 表）','动态试算'],['康言','医生组','在管 12 人 · 出院费用 16.76 万','住院规模（9.13—9.19 表）','动态试算'],['王建','医生组','在管 11 人','住院规模（9.13—9.19 表）','动态试算'],['赵郁莹','医生组','在管 10 人','住院规模（9.13—9.19 表）','动态试算']],
