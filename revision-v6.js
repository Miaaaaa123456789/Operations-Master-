(function(){
  ...
  function reorderMarketing(){
    ...
    const priority=document.createElement('section');priority.className='mkt-priority';priority.innerHTML=`
      <article class="mkt-card priority-compare"><div class="mkt-card-head"><div><span class="priority-label">↗ 环比分析</span><h2>本周至今经营变化</h2><p>营收 9.21—9.25（5 天）· 触达类 9.21—9.24（4 天），各自与上周同期同天数对照</p></div><span class="mkt-badge">营业额 +19.4%</span></div>
        <div class="priority-matrix"><div class="head">指标（同期天数）</div><div class="head">上周同期</div><div class="head">本周至今</div><div class="head">变化</div><b>营业额（5 天）</b><span>29.28万</span><span>34.97万</span><span class="good">+19.4%</span><b>客服随访（4 天）</b><span>46条</span><span>52条</span><span class="good">+13.0%</span><b>标记到院（4 天）</b><span>17人</span><span>18人</span><span class="good">+5.9%</span><b>营销对接（4 天）</b><span>24条</span><span>28条</span><span class="good">+16.7%</span><b>营销入院（4 天）</b><span>4人</span><span>8人</span><span class="good">+100%</span></div>
        <p class="priority-summary">营收提速明显：9.25 单日 10.12 万为本周峰值，本周累计 34.97 万、较上周同期 +19.4%；客服随访 +13.0%、营销对接 24→28 条、入院 4→8 人（转化率 28.6%）。但到院率由 37.0% 降到 34.6%，且入院样本仍小，需患者级去重与收费归因后才能定论。</p></article>
  ...
  const deptData={
    butler:{title:'管家组',subtitle:'本周 9.21—9.26 逐条 63 条 · 上周 80 条',metrics:[['有效对接','63条'],['转住院','13人'],['转住院率','20.6%'],['本周无新增','菲菲 / 国威']],html:`<div class="rank-note rank-ok">本周（9.21—9.26）有效对接 <b>63 条</b>、转住院 <b>13 人（20.6%）</b>；上周 9.14—9.20 为 80 条 / 14 人（17.5%），对接环比 <b>-21.2%</b>。个人样本仅十余条，率值只作趋势参考，不作绩效排序。</div><div class="rank-list"><div class="rank-row"><i>1</i><div><b>朱婧</b><small>有效对接 26 条 · 检查 20 · 转住院 11.5%</small></div><strong>26条</strong></div><div class="rank-row"><i>2</i><div><b>金林</b><small>有效对接 24 条 · 物理 9 · 转住院 29.2%（最高）</small></div><strong>24条</strong></div><div class="rank-row"><i>3</i><div><b>利娟</b><small>有效对接 13 条 · 检查 5 · 转住院 23.1%</small></div><strong>13条</strong></div><div class="rank-row"><i>4</i><div><b>菲菲</b><small>本周无新增对接记录</small></div><strong>0条</strong></div><div class="rank-row"><i>5</i><div><b>国威</b><small>本周无新增对接记录</small></div><strong>0条</strong></div></div>`},
