(function(){
  ...
  function reorderMarketing(){
    ...
    const priority=document.createElement('section');priority.className='mkt-priority';priority.innerHTML=`
      <article class="mkt-card priority-compare"><div class="mkt-card-head"><div><span class="priority-label">↗ 环比分析</span><h2>本周至今经营变化</h2><p>9.21—9.24 与上周同期 9.14—9.17 同口径（各 4 天）</p></div><span class="mkt-badge">营业额 +13.3%</span></div>
        <div class="priority-matrix"><div class="head">指标（同期天数）</div><div class="head">上周同期</div><div class="head">本周至今</div><div class="head">变化</div><b>营业额（4 天）</b><span>21.94万</span><span>24.85万</span><span class="good">+13.3%</span><b>客服随访（4 天）</b><span>46条</span><span>52条</span><span class="good">+13.0%</span><b>标记到院（4 天）</b><span>17人</span><span>18人</span><span class="good">+5.9%</span><b>营销对接（4 天）</b><span>24条</span><span>28条</span><span class="good">+16.7%</span><b>营销入院（4 天）</b><span>4人</span><span>8人</span><span class="good">+100%</span></div>
        <p class="priority-summary">触达与收入同向增长：营业额 +13.3%、客服随访 +13.0%、营销对接 24→28 条、入院 4→8 人（转化率 28.6%）。但到院率由 37.0% 降到 34.6%，且入院样本仍小，需患者级去重与收费归因后才能定论。</p></article>
